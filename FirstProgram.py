...
print("my name is sam.", "23 is my age" )

print("my name is sam.\n", "MIT is my college name.")

#------------------------ Variables-------------------------------------------------------

name = "Shraddha"   # string
print(name)
...
num_1 = float(input("Enter the first float number:"))
num_2 = float(input("Enter the second float number:"))
